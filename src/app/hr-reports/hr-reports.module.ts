...
@NgModule({
  declarations: [VacancyReportComponent, ReportsDashboardComponent, LastLoginReportComponent, EmpApplicationTrackReportComponent, EmployeeSkillReportComponent, VacancybycompanyComponent],
  imports: [
    CommonModule,
